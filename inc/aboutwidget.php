...
class AboutWidget extends WP_Widget{
    ...
    {
        parent::__construct('about-widget', 'Zimperfect About Us');
    ...
    public function form($instance){
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'Text' ) ); ?>"><?php echo esc_html__( 'Text:', 'zimperfect-theme-textdomain' ); ?></label>
